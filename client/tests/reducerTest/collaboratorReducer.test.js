...
describe('collaborator reducer', () => {
  ...
  it('should add collaborator when passed' +
  ...
  it('should add collaborator error message' +
  'when passed ADD_COLLABORATOR_FAILURE',
  () => {
  ...
  it('should add fetch collaborator success' +
  'message when passed FETCH_COLLABORATOR_SUCCESS', () => {
